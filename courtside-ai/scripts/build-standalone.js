...
html = html.replace('<title>CourtSide AI — 2-court demonstrator</title>', '<title>CourtSide AI — standalone 2-court demonstrator</title>');
fs.mkdirSync(out, { recursive: true });
const file = path.join(out, 'courtside-standalone.html');
